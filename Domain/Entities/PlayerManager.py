...
from Domain.Interfaces.IPlayerStateObserver import IPlayerStateSubject,IPlayerStateObserver

class PlayerManager(IMoleObserver,IPlayerStateSubject):
    
    def __init__(
        self, 
        state_observers: Union[Collection[IPlayerStateObserver], IPlayerStateObserver]=[], 
        ):
